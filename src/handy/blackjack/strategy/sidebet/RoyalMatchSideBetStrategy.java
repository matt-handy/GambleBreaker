...
public class RoyalMatchSideBetStrategy extends SideBetStrategy {

	// El Cortez

	public enum ROYAL_MATCH_STRAT {
		NAIVE, TENS
	};

	ROYAL_MATCH_STRAT strat;
	...
	public RoyalMatchSideBetStrategy(int baseBet, ROYAL_MATCH_STRAT strat, int decks, float requiredTens) {
		super(baseBet);
	...
	public int getBet(Shoe shoe, Hand playerHand, Card dealerUpCard, int regularBet) {
		if (strat == ROYAL_MATCH_STRAT.NAIVE) {
			return baseBet;
		} else {
